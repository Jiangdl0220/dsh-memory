...
/** The settings-nav glyph: a circular double-arrow (recall/reload), painted
 *  over the default gear via a CSS mask. */
const NAV_PATH = 'M23 4v6h-6M1 20v-6h6M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15'

const NAV_MASK = 'data:image/svg+xml,' + encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path fill='none' stroke='#000' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' d='${NAV_PATH}'/></svg>`)
